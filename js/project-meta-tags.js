...
(function () {
  ...
  var PROJECT_DATA_BY_NUMBER = {
    '97': { date: '02.2026', country: 'Казахстан', tags: [], title: '*NDA*' },
    '96': { date: '02.2026', country: 'Кыргызстан', tags: ['OOH', 'Генерация', 'Кей-вижуал', 'Концепция'], title: 'Промо доставки еды на автобусных остановках', description: 'Дизайн для промо доставки из ресторанов и магазинов на остановках в Кыргызстане. Сгенерили 3 сцены в нейронках для Еды, Продуктов и Плюса и растиражировали на 2 города.' },
    '95': { date: '02.2026', country: 'Казахстан', tags: ['OOH', 'Генерация', 'Концепция'], title: 'Брендирование машин Еды', description: 'Задизайнили концепции оформления курьерских машин для доставки Еды в Казахстане.' },
    '94': { date: '02.2026', country: 'Беларусь', tags: ['Digital', 'OLV', 'Генерация', 'Кей-вижуал', 'Озвучка'], title: 'Промо на первый заказа в Евроопт' },
    '93': { date: '02.2026', country: 'Замбия', tags: ['Digital', 'InApp', 'OLV', 'Генерация', 'Кей-вижуал', 'Концепция'], title: 'Промо-кампания с розыгрышем iPhone для Yango', description: 'Разработали концепцию кей-вижуала, сгенерили ai-сцену, разложили на in-app форматы и собрали анимацию для партнерской трансляции.' },
    '92': { date: '01.2026', country: 'Узбекистан', tags: ['OOH', 'Генерация', 'Ивент', 'Кей-вижуал'], title: 'Кей-вижуал и носители для ивента в пиццерии Belissimo Pizza' },
    '91': { date: '01.2026', country: 'Узбекистан', tags: ['DOOH', 'Digital', 'OLV', 'Генерация', 'Кей-вижуал', 'Озвучка'], title: 'Промо для прерамадана с EVOS', description: 'Занимировали olv и dooh ролик. Перегенерили партнерский фуд и заанимировали его в нейронках.' },
    '90': { date: '12.2025', country: 'Узбекистан', tags: [], title: '*NDA*', description: 'Промо ролик в зону выдачи багажа в Ташкентский аэропорт.' },
    '89': { date: '12.2025', country: 'Беларусь', tags: ['3D', 'Digital', 'InApp', 'Генерация', 'Кей-вижуал', 'Концепция'], title: 'Бургер-фест', description: 'Разработали кей-вижуал для Бургер-феста в Беларуси. Придумали визуальное направление, сгенерили фуд, леттеринг и 3д-персонажа. Растиражили все на форматы in-app и SMM.' },
    '88': { date: '12.2025', country: 'Казахстан', tags: ['Digital', 'OLV', 'Генерация', 'Кей-вижуал', 'Озвучка'], title: 'OLV и кей-вижуал для промо Новичкового оффера Bahandi' },
    '87': { date: '11.2025', country: 'Казахстан', tags: ['Digital', 'OLV', 'Генерация'], title: 'Апдейт новогодней промо-кампании' },
    '86': { date: '12.2025', country: 'Беларусь', tags: [], title: '*NDA*' },
    '85': { date: '11.2025', country: 'Беларусь', tags: [], title: '*NDA*' },
    '84': { date: '12.2025', country: 'Кыргызстан', tags: ['DOOH', 'Digital', 'OLV', 'Генерация', 'Кей-вижуал', 'Озвучка'], title: 'Новогоднее промо для Азии Ритейл в Кыргызстане' },
    '83': { date: '12.2025', country: 'Казахстан', tags: [], title: '*NDA*' },
    '82': { date: '11.2025', country: 'Казахстан', tags: ['DOOH', 'Digital', 'OLV', 'Генерация', 'Кей-вижуал', 'Озвучка'], title: 'Новогодняя промо-кампания', description: 'Подготовили материалы для новогодней промо-кампании Яндекса в Казахстане.Сгенерили партнерские и дженерик фуды в новогодней атмосфере, собрали olv и dooh анимацию и растиражировали на 300+ роликов.' },
    '81': { date: '12.2025', country: 'Узбекистан', tags: ['DOOH', 'Генерация', 'Кей-вижуал'], title: 'Промо доставки из аптек', description: 'Разработали визуал для промо доставки из аптек в Узбекистане и заанимировали dooh-ролик.' },
    '80': { date: '12.2025', country: 'Узбекистан', tags: ['Digital', 'OLV', 'Генерация', 'Кей-вижуал', 'Озвучка'], title: 'Промо с Oqtepa Lavach' },
    '79': { date: '11.2025', country: 'Узбекистан', tags: ['Digital', 'OLV', 'Генерация', 'Кей-вижуал', 'Озвучка'], title: 'Кейвижуал для новогодней промо-кампании' },
    '78': { date: '11.2025', country: 'Узбекистан', tags: [], title: '*NDA*' },
    '77': { date: '12.2025', country: 'Узбекистан', tags: ['DOOH'], title: 'Наружка для партнеров в ритейле' },
    '76': { date: '11.2025', country: 'Армения', tags: [], title: '*NDA*' },
    '75': { date: '11.2025', country: 'Казахстан', tags: [], title: '*NDA*' },
    '74': { date: '11.2025', country: 'Казахстан', tags: ['OLV', 'Озвучка'], title: 'Ролик в курьерский хаб' },
    '73': { date: '09.2025', country: 'Узбекистан', tags: ['DOOH', 'Digital', 'OLV', 'Генерация', 'Кей-вижуал', 'Озвучка'], title: 'Промо-кампания Черной пятницы', description: 'Один из самых объемных проектов. Тут делали раскатку креативной рамки Черной пятницы на нескольких партнеров. Собрали мастера раскадрвок, сгенериили фуды и растиражили на сотни носителей в наружке и диджитале.' },
    '72': { date: '09.2025', country: 'Беларусь', tags: ['DOOH', 'OLV'], title: 'Промо доставки продуктов из супермаркетов' },
    '71': { date: '10.2025', country: 'Беларусь', tags: ['Digital', 'InApp', 'Генерация', 'Иллюстрация', 'Кей-вижуал', 'Концепция'], title: 'Пицца-фест', description: 'Разработали кей-визуал для промо в приложении. Сгенерили сцену и нарисовали стикеры.' },
    '70': { date: '09.2025', country: 'Казахстан', tags: ['DOOH', 'Генерация', 'Кей-вижуал'], title: 'Промо-кампания «Уютный октябрь» с Okadzaki' },
    '1': { date: '10.2025', country: 'Казахстан', tags: ['Digital', 'OLV', 'Генерация', 'Кей-вижуал', 'Озвучка'], title: 'Промо первого заказа из I\'m' },
